...
# to the NXxeuler application definition.
#
...
outf.putdata(data)
data = 'http://svn.nexusformat.org/definitions/NXxeuler.nxdl.xml'
...
copyData(inf,'/entry1/sample/chi',outf,'chi')
copyData(inf,'/entry1/sample/phi',outf,'phi')
...
makeStink(outf,'/entry/sample/chi','/entry/data')
makeStink(outf,'/entry/sample/phi','/entry/data')
