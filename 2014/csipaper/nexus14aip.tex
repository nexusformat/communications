...
\item A dictionary of documented domain-specific field expressed in the form of \emph{base classes}
...
NeXus uses a group hierarchy for arranging data in an HDF5 file.  Data files may contain raw data or processed data or both, each of which has a hierarchy.  Groups may contain data fields and may also contain other groups.  The content of any NeXus group is defined by either a base class, an application definition, or a contributed definition.
...
\subsection{Processed Data Hierarchy}
