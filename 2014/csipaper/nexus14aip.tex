...
a NXdata group must be provided at NXentry level.
It contains information about plot axes and links to the data
(which typically reside in the NXdetector group).
...
(technically, this name is the value of the HDF5 attribute NXclass). For each of these NeXus base classes, there 
