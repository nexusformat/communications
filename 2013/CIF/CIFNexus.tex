...
\end{itemize}
\begin{figure}[!ht]
\resizebox{6cm}{6cm}{\includegraphics[width=0.5\textwidth]{mcstas.png}}
\end{figure}
\end{frame}
...
\begin{figure}[!ht]
\resizebox{10cm}{8cm}{\includegraphics[width=0.9\textwidth]{raw.png}}
\end{figure}
\end{frame}
...
\begin{figure}[!ht]
\resizebox{10cm}{8cm}{\includegraphics[width=0.9\textwidth]{scan.png}}
\end{figure}
\end{frame}

\begin{frame} \frametitle{Processed Data Structure}
\begin{figure}[!ht]
\resizebox{10cm}{8cm}{\includegraphics[width=0.9\textwidth]{proc.png}}
\end{figure}
\end{frame}
...
\begin{itemize}
\item It is easy to write NeXus files with HDF-5 tools alone
\item NeXus API exists:
\begin{itemize}
\item Thin layer on top of HDF-APIs
\item NeXus-API hides complex HDF API
\item Transparent access to all three supported physical file formats
\item C, C++, F77, Java, python, IDL, SWIG
\end{itemize}
\end{itemize}
\end{frame}
