...
# $Date: 2011-01-07 13:52:22 -0600 (Fri, 07 Jan 2011) $
# $Author: jemian $
# $Revision: 234 $
# $URL: https://subversion.xor.aps.anl.gov/bcdaext/hdf5_exchange/h5py_examples/src/h5toText/h5toText.py $
# $Id: h5toText.py 234 2011-01-07 19:52:22Z jemian $
########### SVN repository information ###################
'''
...
class H5toText(object):
    ...
    def showGroup(self, obj, name, indentation = "  "):
        ...
        for name, value in obj.items():
            ...
            if str(type(value)) in ("<class 'h5py.highlevel.File'>", "<class 'h5py.highlevel.Group'>"):
                self.showGroup(value, name, indentation = indentation+"  ")
            else:
                self.showDataset(value, name, indentation = indentation+"  ")
...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 1:
	    ...
	    print
            print "SVN: $Id: h5toText.py 234 2011-01-07 19:52:22Z jemian $"
